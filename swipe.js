...
var Swipe = function () {
    function Swipe(container, options) {
        ...
        var self = this;
        this.noop = function () {};
        this.offloadFn = function (fn) {
            setTimeout(fn || self.noop, 0);
        };
        ...
        this.events = {
            ...
            handleEvent: function handleEvent(event) {
                ...
                switch (event.type) {
                    ...
                    case 'touchend':
                        self.offloadFn(this.end(event));break;
                    case 'webkitTransitionEnd':
                    case 'msTransitionEnd':
                    case 'oTransitionEnd':
                    case 'otransitionend':
                    case 'transitionend':
                        self.offloadFn(this.transitionEnd(event));break;
                    case 'resize':
                        self.offloadFn(self._setup);break;
                }
            ...
            move: function move(event) {
                ...
                if (!self.isScrolling) {
                    ...
                    if (self.continuous) {
                        ...
                        self.delta.x = self.delta.x / (!self.index && self.delta.x > 0 || // if first slide and sliding left
                ...
                var isPastBounds = !self.index && self.delta.x > 0 || // if first slide and slide amt is greater than 0
                ...
                if (!self.isScrolling) {
                    ...
                    if (isValidSlide && !isPastBounds) {
                        ...
                        var index = self.special ? self.index % 2 : self.index;
    ...
    _createClass(Swipe, [{
        ...
        value: function _prev() {
            ...
            if (this.continuous) this._slide(this.index - 1);else if (this.index) this._slide(this.index - 1);
        }
    }, {
        key: '_next',
        ...
        key: '_slide',
        value: function _slide(to, slideSpeed) {
            ...
            this.index = to;
            var index = this.special ? this.index % 2 : this.index;
        ...
        key: '_animate',
        value: function _animate(from, to, speed) {
